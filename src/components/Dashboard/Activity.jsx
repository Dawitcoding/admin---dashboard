...
const activities = [
  ...
  },
  {
    ...
    description: "iphone pro 15 ordered.",
    time: "32 minutes ago",
  ...
  },
  {
    ...
    description: "payment of $245 completed",
    time: "2 hours ago",
  ...
  },
  {
    ...
    icon: Settings,
    title: "system update",
    description: "storage backup completed",
    time: "4 hours ago",
          ...
          {activities.map((activity) => (
            <div className="flex items-start space-x-4 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 trancate">
